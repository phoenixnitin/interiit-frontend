...
@Component({
    ...
    templateUrl:'./app/scheduleandresult/general_championship/general_championship.html',
    styleUrls:['./app/assets/css/scheduleandresults.css', './app/assets/css/common.css']
})

export class GeneralChampionshipComponent implements OnInit, AfterViewInit{
